...
import BrannAddonAfterInput from "components/ui/input/AddonAfterInput";

export default function Emergency() {
  return (
    <React.Fragment>
      <Form.Item>
        <BrannSubTitle text="Beredskap" />
      </Form.Item>
      <Row gutter={16}>
        <Col span={12}>
      ...
      <Row gutter={16}>
        <Col md={12} xs={24} sm={24}>
          <Form.Item name="email" rules={[required]} label="Innsatstid i min">
            <BrannAddonAfterInput addon="min" placeholder="Innsatstid i min" />
          </Form.Item>
        </Col>
        <Col md={12} xs={24} sm={24}>
          <Form.Item
            name="phone"
            rules={[required]}
            label="Tilrettelegging for innsatsmannskaper"
          >
            <BrannInput placeholder="Tilrettelegging for innsatsmannskaper" />
          </Form.Item>
        </Col>
      </Row>
    </React.Fragment>
